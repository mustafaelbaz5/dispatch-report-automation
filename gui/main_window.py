"""
gui/main_window.py — Application root window.

Wires all panels together and owns the shared state + worker thread logic.
No widget creation happens here — every visual piece lives in its panel.
"""
...
class MainWindow(ctk.CTk):
    ...
    def __init__(self):
        ...
        icon = ImageTk.PhotoImage(Image.open("car_logo.jpeg"))
    ...
    def _build_ui(self) -> None:
        ...
        # Log panel — hidden by default, packed by toggle()
    ...
    def _reset(self) -> None:
        # Find the DropzoneCard and call reset() on it
    ...
    def _find_and_reset_dropzone(self, widget) -> None:
        """Walk widget tree to find DropzoneCard and call reset()."""
